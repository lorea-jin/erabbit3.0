<template>
  <div class="home-product" ref="productRef">

    <HomePanel v-for="item in goodList" :key="item.id" :title="item.name">
...
export default {
  ...
  setup () {
    ...
    let goodList = ref([])
    goodList = useLazyData(productRef, findGoods)

    return { productRef, goodList }
  }
}
</script>
